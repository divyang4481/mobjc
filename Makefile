...
docs: libs
	mmmdoc --out=docs --see-also='http://code.google.com/p/mobjc/w/list mobjc' --extra-dict=mobjc.dict --see-also='http://code.google.com/p/mcocoa/w/list mcocoa' bin/mobjc.dll,bin/docs.xml
